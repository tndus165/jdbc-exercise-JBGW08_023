...
public class ClubRegistrationRepositoryImpl implements ClubRegistrationRepository {
    ...
    public List<ClubStudent> findClubStudents_outher_excluding_join(Connection connection) {
        ...
        sb.append(System.lineSeparator());
        //right join
        sb.append("select a.id as student_id, a.name as student_name, c.club_id, c.club_name from jdbc_students a ight join jdbc_club_registrations b on a.id=b.student_id right join jdbc_club c on b.club_id=c.club_id where a.id is null");
